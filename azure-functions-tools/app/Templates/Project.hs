...
cabalFile name = toTemplate (name <> ".cabal") [r|
cabal-version: 2.24
...
-- Do NOT manually update this stanza.
-- it will be re-generated automatically when new functions are added to the project
common functions:
  exposed-modules:
